...
// "http://localhost:33456/post/comparisonData"; // edgeServer2
...
// } else {
// System.err.println(
// "发送失败: " + cmp.clientId1 + ", " + cmp.clientId2 + " 状态码:" +
// response.statusCode());
// }
// } catch (Exception e) {
...
// public ComparisonCipherText(String clientId1, String clientId2, String
